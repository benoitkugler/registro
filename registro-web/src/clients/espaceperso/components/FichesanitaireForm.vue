  ...
  >
    ...
    <v-card-text>
      <v-alert v-if="props.fiche.IsLocked">
        ...
        droits de lecture et d'écriture. Un mail contenant un lien de transfert
        va être envoyé
        {{ ownerMails.length >= 2 ? "aux adresses" : "à l'adresse" }}
        <i>({{ ownerMails.join(" ; ") }})</i>.
      ...
      <v-alert
        ...
        type="warning"
      >
        Merci de bien vouloir vérifier que les données ci-dessous sont à jour et
        les valider.
      ...
      <template v-if="!props.fiche.IsLocked">
        ...
        >
          <v-card-text class="text-black">
            ...
            Il autorise le responsable du séjour à prendre des mesures urgentes
            de soin (traitements médicaux d'urgence, hospitalisation,
            interventions chirurgicales) rendues nécessaires par l’état du
            participant.
            <br />
            Il autorise également, si nécessaire, le responsable du séjour à
