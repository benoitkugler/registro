...
//go:generate ../../../go/src/github.com/benoitkugler/gomacro/cmd/gomacro -http-api=/api routes_equipier.go typescript/api:../registro-web/src/clients/equipier/logic/api.ts
