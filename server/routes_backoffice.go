...
func setupRoutesBackoffice(e *echo.Echo, ct *backoffice.Controller) {
	...
	gr.GET("/api/v1/backoffice/camps/sondages", ct.CampsLoadSondages)

	gr.GET("/api/v1/backoffice/camps/projet-spi", ct.CampsLoadProjetSpi)
	...
	gr.GET("/api/v1/backoffice/personnes/fiche-sanitaire", ct.PersonnesLoadFichesanitaire)
	gr.POST("/api/v1/backoffice/personnes/fiche-sanitaire", ct.PersonnesUpdateFichesanitaireAccess)
}
