...
func randEventKind() EventKind {
	choix := [...]EventKind{Supprime, Message, Inscription, AccuseReception, Facture, Documents, FactureAcquittee, AttestationPresence, Sondage, PlaceLiberee}
	i := rand.Intn(len(choix))
	return choix[i]
}
...
func randVuPar() VuPar {
	return VuPar(randAr3_bool())
}
